...
const Terms = () => {
    return (
        <>
            <Meta
                title="Terms | Daine Mawer"
                description="Just a few things you need to know about using the site."
                url="https://dainemawer.com/terms"
            />
            <Layout>
                <Hero title="Terms &amp; Conditions." subtitle="Just a few things you need to know about using the site." />
