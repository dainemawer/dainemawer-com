 ...
 * 🍪 Cookies
 *
 * Renders the Cookies Page Template.
 *
 * @author Daine Mawer
 * @version 1.0
 *
...
const Cookies = () => (
    <>
        <Meta
            title="Cookies | Daine Mawer"
            description="How my site uses cookies."
            url="https://dainemawer.com/cookies"
        />
        <Layout>
            <Hero title="Cookies" subtitle="How my site uses cookies." />
