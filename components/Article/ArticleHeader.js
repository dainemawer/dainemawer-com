    ...
    return (
        <header>
            <div className={styles.container}>
                <time className={styles.time} dateTime={published}>{formatDate(published)}</time>
                <ul className={styles.list}>
                    <li className={styles.item}>
                        <a className={styles.link} href={`http://twitter.com/share?text=${postTitle}&url=${permalink}`}>
                            <svg className={styles.svg} fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px">
